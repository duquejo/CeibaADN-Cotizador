  ...
  <Layout title="Inicio" description="Página inicial">
    ...
    <div>
      <ol>
        ...
        <li>Soporte para peticiones Http con <a target="_blank" rel="noopener noreferrer" href="https://github.com/axios/axios">axios</a>. Existe una instancia de axios que esta configurada con información que es transversal a todas las peticiones. Cada que se necesite acceder a una Api se recomienda usar esta instancia que se encuentra en <strong>src/core/config/AxiosConfig.ts</strong></li>
        <li>Uso de  <a target="_blank" rel="noopener noreferrer" href="https://create-react-app.dev/docs/adding-custom-environment-variables/">variables por ambiente</a>; existén dos archivos .env.development (variables en ambiente desarrollo) y .env.production (variables para producción, reemplazadas cuando se ejecuta la tarea <strong>npm run build</strong>). Adicionalmente puede crear más archivos de variables como está descrito en el link. </li>
    ...
    <ol>
      <li>Se utiliza la guía de estilos de <a href="https://angular.io/guide/styleguide">Angular</a> adaptada para <a href="https://medium.com/@amcdnl/react-for-the-angular-dev-be21a39a382">react.</a></li>
    </ol>
    ...
    <div>
      <ol>
        ...
        <li><code>npm start</code> inicia la aplicación en modo desarrollo, puede abrir el navegador en la siguiente url <a href="http://localhost:3000">http://localhost:3000</a></li>
