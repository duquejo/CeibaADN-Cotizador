    ...
    <Layout title="Inicio" description="Página inicial">
      ...
      <div>
        <ol>
          ...
          existen dos archivos .env.development (variables en ambiente desarrollo) y .env.production (variables para producción, reemplazadas cuando se ejecuta la tarea 
      ...
      <ol>
        <li>Se utiliza la guía de estilos de <a href="https://angular.io/guide/styleguide">Angular</a> adaptada 
        para <a href="https://medium.com/@amcdnl/react-for-the-angular-dev-be21a39a382">react.</a></li>
      </ol>
      ...
      <div>
        <ol>
          ...
          <li><code>npm start</code> inicia la aplicación en modo desarrollo, puede abrir el navegador en la siguiente 
          url <a href="http://localhost:3000">http://localhost:3000</a></li>
